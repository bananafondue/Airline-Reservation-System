...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <div class="col-lg-6 col-md-8 mx-auto" style="margin-top: 50px">
        <h1 class="fw-dark" style="text-align: center">BOOK A FLIGHT</h1>
        <p style="text-align: center">There is no better way to fly.</p>
      </div>     
      <h2 class="border-bottom pb-2 px-4">Available Flights</h2>
      ...
      if($count > 0){
        while($flight = mysqli_fetch_array($result)){
          echo "
          <div class='col d-flex align-items-start'>
            ...
            <div>
              ...
              <h2> {$flight['departure']} to {$flight['destination']} </h2>
            
              <p>
              
                <b>Airline Name: </b>{$flight['airlinename']}
                <br />
                ...
                <br />
                Flight no:
                <input name='flightno' readonly='readonly' value='{$flight['flightno']}' class='form-control float-child' style='background: transparent; border: none'/>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Enter details of passenger</h5>
              <button
                type="button"
                class="btn-close"
